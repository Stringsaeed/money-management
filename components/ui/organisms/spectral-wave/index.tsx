...
const SpectralWaveComponent: React.FC<ISpectralWave> = ({
  ...
  return (
    <View style={[styles.wrapper, { width, height, borderRadius }, style]}>{shaderCanvas}</View>
  );
};

export const SpectralWave = memo(SpectralWaveComponent);
