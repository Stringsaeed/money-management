// oxlint-disable anti-slop/no-module-mocking, anti-slop/require-safety-comment-for-type-assertion -- native gesture callbacks use deterministic test doubles.
