/**
 * Config plugin to add UIScene lifecycle support required by iOS 27+.
 *
 * iOS 27 requires apps built with Xcode 27 SDK to use UIScene lifecycle (Apple TN3187).
 * Expo SDK 57 doesn't include UIScene support yet (pending #46733/#46734).
 *
 * This plugin is based on the community pattern from:
 * - https://github.com/YesterdaysLemon/expo-ios-scene-lifecycle-plugin
 * - https://github.com/expo/expo/issues/46663
 *
 * It adds:
 * - UIApplicationSceneManifest to Info.plist
 * - SceneDelegate class owning window + startReactNative
 * - Strips window creation from didFinishLaunchingWithOptions
 * - Forwards deep links from scene to AppDelegate
 */
