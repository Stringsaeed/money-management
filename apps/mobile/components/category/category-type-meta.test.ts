...
import { CATEGORY_TYPE_META } from "./category-form-options";

describe("CATEGORY_TYPE_META", () => {
  it("locks expense and income category type metadata", () => {
    expect(CATEGORY_TYPE_META).toEqual({
      expense: {
        value: "expense",
        label: "Expense",
        emoji: "💸",
