...
```bash
bash packages/infra/scripts/powersync-z0/smoke.sh
```
...
```bash
bash packages/infra/scripts/powersync-z0/smoke.sh --bench
```
...
```bash
bash packages/infra/scripts/powersync-z0/smoke.sh --teardown
```
