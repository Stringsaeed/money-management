...
- **#227 is done.** Envelopes, assignments, budget projections, and recurring rules are ledger-scoped. Personal rules settle without a Household. Membership and import remain Household-only. #229 still owns importing on-device rows onto a Personal Ledger.
