...
| HEAD                | tip after this Relates stamp — **#266 merged + Deploy [34715924235](https://github.com/Stringsaeed/money-management/actions/runs/34715924235) SUCCESS**; ensure soft-fail `42501`/`42703` exit 0; live webhook **400/401** (secret live; was 503). Remaining **BLOCKED/FAIL**: webhook membership-apply (needs signed delivery), #258–#265 Create Account/NativeButton **PARKED**, dual-token/`CERT_USER_*`, GH Actions tip billing, Android, OTP AX, PowerSync mint, signed-in Mac session |
| Provenance          | Squash merge of #240 / closes #231 on `main`, plus [#242](https://github.com/Stringsaeed/money-management/pull/242), [#245](https://github.com/Stringsaeed/money-management/pull/245), [#246](https://github.com/Stringsaeed/money-management/pull/246), [#259](https://github.com/Stringsaeed/money-management/pull/259), [#266](https://github.com/Stringsaeed/money-management/pull/266) (`33a8ba23`), and schema **0011–0015** on PlanetScale `trove/main`.   |
| Worktree            | `/tmp/wt-241-post266` (this stamp); prior `/tmp/wt-241-cert232-ddl`; Mac evidence from Muhammed's Mac self-hosted worker `1243a933-…`                                                                                                                                                                                   |
| Live API            | `https://auth.trove.ing` — root **200 OK**; Sync `getManifest` CF Worker **200** post-DDL; webhook **400** missing sig / **401** bad sig after #266 Deploy (see `post-266-deploy-webhook-progress-2026-09-12T2006Z.md`). Schema on PlanetScale still **PASS**. |
| Device (this write) | iPhone 17 Pro `6E4BBB8A-790E-4DDD-995B-6A3D1D9101DB` on Muhammed's Mac (`saeed-personal.local`) — agent-device Create Account **FAIL** vs #260 tip `ed1fc13b` (`hittable=false`)                                                                                                                                                      |
...
Recorded in `post-266-deploy-webhook-progress-2026-09-12T2006Z.md` / `workos-webhook-probe-2026-09-12T200641Z.txt` / `local-ci-authority-2026-09-12.txt` / `local-ci-authority-commands-2026-09-12.txt` / `workos-webhook-probe-2026-09-12T192327Z.txt` / `workos-webhook-after-259-still-503.md` / `garden-stage-for-step-jest-2026-09-12.txt` / `preset-key-for-jest-2026-09-12.txt` / `revision.txt` / `create-account-hittest-status.md` / `ci-stamp-2026-09-12.txt` / `ci-billing-blocked-2026-09-12.txt` / `post-schema-sync-retest.md` / `isolation-helpers-jest-2026-09-12.txt` / `claim-store-jest-2026-09-12.txt` / `membership-revocation-jest-2026-09-12.txt` / `session-probe-jest-2026-09-12.txt` / `ledger-source-offline-jest-2026-09-12.txt` / `memberships-role-jest-2026-09-12.txt` / `access-core-capabilities-jest-2026-09-12.txt` / `workos-webhook-probe-2026-09-12T141932Z.txt` / `workos-webhook-probe-2026-09-12e.txt` / `workos-webhook-probe-2026-09-12d.txt` / `workos-verify-env-jest-2026-09-12.txt` / `widget-handoff-jest-2026-09-12.txt` / `reconcile-freshness-jest-2026-09-12.txt` / `command-shared-ledger-powersync-jest-2026-09-12.txt` / `sole-admin-budget-pure-jest-2026-09-12.txt` / `card-dependency-setup-draft-jest-2026-09-12.txt` / `import-content-jest-2026-09-12.txt` / `to-directory-membership-jest-2026-09-12.txt` / `import-manifest-canonical-jest-2026-09-12.txt` / `household-role-command-kind-jest-2026-09-12.txt` / `covers-effects-jest-2026-09-12.txt` / `period-helpers-jest-2026-09-12.txt` / `session-from-claims-jest-2026-09-12.txt` / `bind-ledger-scope-jest-2026-09-12.txt` / `is-plan-rejection-jest-2026-09-12.txt` / `household-import-binding-jest-2026-09-12.txt` / `new-deletion-operation-id-jest-2026-09-12.txt` / `command-scope-precondition-schema-jest-2026-09-12.txt` / `create-payload-schemas-jest-2026-09-12.txt` / `recurring-change-payload-schema-jest-2026-09-12.txt` / `update-archive-account-payload-schemas-jest-2026-09-12.txt` / `edit-remove-transaction-payload-schemas-jest-2026-09-12.txt` / `create-update-category-payload-schemas-jest-2026-09-12.txt` / `archive-category-payload-schema-jest-2026-09-12.txt` / `to-wire-account-type-jest-2026-09-12.txt` / `budget-period-of-jest-2026-09-12.txt` / `date-after-jest-2026-09-12.txt` / `settlement-effects-jest-2026-09-12.txt` / `format-activity-full-timestamp-jest-2026-09-12.txt` / `pending-lifecycle-settlement-jest-2026-09-12.txt` / `envelope-category-mapping-content-jest-2026-09-12.txt` / `funding-rollover-content-jest-2026-09-12.txt` / `assignment-content-jest-2026-09-12.txt` / `recurring-rule-content-jest-2026-09-12.txt` / `ledger-read-fields-jest-2026-09-12.txt` / `create-console-sink-jest-2026-09-12.txt` / `create-metrics-sink-jest-2026-09-12.txt` / `apply-ledger-filters-jest-2026-09-12.txt` / `change-effects-jest-2026-09-12.txt` / `date-range-of-jest-2026-09-12.txt` / `validate-move-request-jest-2026-09-12.txt` / `page-transactions-jest-2026-09-12.txt` / `to-edit-date-jest-2026-09-12.txt` / `summarize-transactions-jest-2026-09-12.txt` / `apply-move-to-projection-jest-2026-09-12.txt` / `query-filters-to-ledger-jest-2026-09-12.txt` / `month-filter-jest-2026-09-12.txt` / `apply-ledger-balance-jest-2026-09-12.txt` / `require-category-ids-jest-2026-09-12.txt` / `assert-source-has-money-jest-2026-09-12.txt` / `candidate-from-draft-jest-2026-09-12.txt` / `apply-budget-transaction-jest-2026-09-12.txt` / `stale-result-jest-2026-09-12.txt` / `invalid-lifecycle-jest-2026-09-12.txt` / `candidate-from-existing-jest-2026-09-12.txt` / `draft-from-rule-jest-2026-09-12.txt` / `require-envelope-fields-jest-2026-09-12.txt` / `require-changed-category-ids-jest-2026-09-12.txt` / `require-restored-category-confirmation-jest-2026-09-12.txt` / `update-setup-draft-funding-accounts-jest-2026-09-12.txt` / `toggle-setup-draft-rollover-jest-2026-09-12.txt` / `remove-setup-draft-category-jest-2026-09-12.txt` / `describe-summarize-effects-vitest-2026-09-12.txt` / `issues-expected-version-scope-columns-vitest-2026-09-12.txt` / `is-kill-switch-engaged-vitest-2026-09-12.txt` / `sha256-hex-vitest-2026-09-12.txt` / `encode-decode-ledger-selection-jest-2026-09-12.txt` / `personal-import-binding-jest-2026-09-12.txt` / `serialize-return-to-jest-2026-09-12.txt` / `can-present-open-auth-sheet-jest-2026-09-12.txt` / `to-membership-summary-role-label-jest-2026-09-12.txt` / `next-claim-jest-2026-09-12.txt` / `pick-active-household-jest-2026-09-12.txt` / `resolve-return-destination-jest-2026-09-12.txt` / `household-read-from-query-jest-2026-09-12.txt` / `command-envelope-schema-vitest-2026-09-12.txt` / `rejection-reason-vitest-2026-09-12.txt` / `account-lifecycle-period-jest-2026-09-12.txt` / `map-session-snapshot-jest-2026-09-12.txt` / `is-unreachable-failure-jest-2026-09-12.txt` / `households-query-key-user-jest-2026-09-12.txt` / `parse-setup-assignment-jest-2026-09-12.txt` / `evaluate-card-budget-state-jest-2026-09-12.txt` / `powersync-availability-jest-2026-09-12.txt`.


## Post-#266 Deploy SUCCESS + webhook 400/401 (2026-09-12T20:06Z, no device)

- [#266](https://github.com/Stringsaeed/money-management/pull/266) squash-merged to `main` `33a8ba23`. Deploy Worker [34715924235](https://github.com/Stringsaeed/money-management/actions/runs/34715924235) **SUCCESS**.
- Ensure `0011–0015`: soft-fail `42501` (alter_permission_denied) + soft-fail `42703` (`visibility` missing_after_denied); final `"ok": true`; step exit 0; Deploy continued.
- Deploy logged `workos_webhook_secret_set=yes`; Alchemy updated `[server/WORKOS_WEBHOOK_SECRET]`.
- Live `POST https://auth.trove.ing/webhooks/workos` → **400** `Missing WorkOS-Signature header.` (no sig); **401** `Signature verification failed.` (fake sig). Was **503**.
- Agent `WORKOS_WEBHOOK_SECRET` **MISSING** → signed delivery probe **SKIPPED** (not invented).
- Evidence: `post-266-deploy-webhook-progress-2026-09-12T2006Z.md` + `workos-webhook-probe-2026-09-12T200641Z.txt`; `workos-webhook-blocked.md` updated to PROGRESS. Relates to #232 only. Do not Closes/Fixes #232/#224. Matrix still incomplete.

## DDL credential probe + PlanetScale schema reconfirm (2026-09-12T19:48Z, no device)

- Agent-env scan: **no** `DATABASE_URL` / `PLANETSCALE_*` / owner DSN — **HARD STOP** for apply-via-env path (secrets not invented).
- PlanetScale MCP read-only on `stringsaeed`/`trove`/`main` (primary): `accounts.ledger_id` present; `visibility` absent (post-0015); cutover tables present; legacy auth tables absent; owners=`postgres`.
- **Verdict:** privileged schema **0011–0015 already PASS**. Deploy ensure `42501`→`42703` is deploy-role ALTER denial cascade (see `deploy-schema-ensure-42703-after-259.md`), not missing columns on `trove/main`.
- Soft-fail Deploy gate remains owner merge [#266](https://github.com/Stringsaeed/money-management/pull/266) — agents do not merge. Live webhook still **503**.
- Evidence: `ddl-cred-probe-and-schema-reconfirm-2026-09-12T1948Z.md` + `.txt`. Relates to #232 only. Do not Closes/Fixes #232/#224. Matrix still incomplete.

## Local CI authority stamp (2026-09-12T19:28Z, no device)

- Commands run on tip `50e8dfcc9c0dcd3d79c674b956cb78131f701072`; this Relates commit rebased onto `ad7cf561` (webhook Relates docs only — no product code between). Worktree `/tmp/wt-241/money-management`; `/workspace` left on `main`.
- **GitHub Actions product CI still BLOCKED** (billing/spend limit). Check runs on tip show GitGuardian only — **no** Typescript/Jest/EAS green claimed. Prior billing annotation evidence: `ci-billing-blocked-2026-09-12.txt`.
- **Interim local authority** (`local-ci-authority-2026-09-12.txt` + command logs):
  - `pnpm --filter @trove/{server,auth,api,infra,db} run check-types` → **EXIT 0**
  - `pnpm -C apps/mobile exec tsc --noEmit` → **EXIT 0**
  - `pnpm --filter @trove/auth run test` → **EXIT 0** (vitest **37/37**)
  - `pnpm --filter @trove/api run test` → **EXIT 0** (vitest **412/412**)
  - `pnpm --filter @trove/db run cutover:test` → **EXIT 0** (**3/3**)
  - mobile Jest `--testPathPattern='modules/access|constants/onboarding'` → **EXIT 0** (**109/109**)
  - `pnpm format:check` → **EXIT 2 FAIL** (pre-existing artifact/format debt)
  - `pnpm lint` → **EXIT 1 FAIL** (pre-existing ~864 oxlint errors)
- Full monorepo `pnpm test:ci` not required for this interim stamp; focused on webhook/auth server packages + mobile access suite.
- Relates to #232 only. Do **not** Closes/Fixes #232/#224. Do **not** claim Actions green. Matrix still incomplete.

## Create Account #260 device FAIL (2026-09-12T16:01:21Z, Mac)

- Host `saeed-personal.local` / Mac14,5; Metro from `apps/mobile` `:8081` serving tip `ed1fc13bf8d291fc9a8ba0d49d15cecf5d8b6330` (PR #260).
- Agent-device only on iPhone 17 Pro (no stim). Skipped Sign in/OTP; local path reached `/account/new` (not BLOCKED_AUTH).
- Create Account 3/3 miss (AX → coord → `testID=create-resource-submit`) with **`hittable=false`** (regression vs #258 `hittable=true`); sibling Savings worked; no new SQLite account row.
- Evidence: `create-account-pr260-fail.md` + `create-account-pr260-*.png`; status `create-account-hittest-status.md`; store handoff `internal/cert-232/pr-260-device-pass.md`.
- Relates to #232 only. Do not Closes #232/#224. Do not merge #260 or #258. Matrix still incomplete.

## Create Account #258 device FAIL (2026-09-12T15:36:16Z, Mac)

- Host `saeed-personal.local` / Mac14,5; Metro from `apps/mobile` `:8081` serving tip `709acf85250c02c8f9746c544da67f0c49f99233` (PR #258).
- Agent-device only on iPhone 17 Pro (no stim). Session remotely revoked; no reusable Keychain session; no `CERT_USER_*`; local path still reached `/account/new` without OTP (not BLOCKED_AUTH).
- Create Account 3/3 miss (AX → coord → `testID=create-resource-submit`) with `hittable=true`; sibling color/type taps worked; no new SQLite account row.
- Evidence: `create-account-pr258-fail.md` + `create-account-pr258-*.png`; status `create-account-hittest-status.md`.
- Relates to #232 only. Do not Closes #232/#224. Do not merge #258. Matrix still incomplete.

## WorkOS webhook post-#259 re-probe (2026-09-12T19:23:27Z, no device)

- [#259](https://github.com/Stringsaeed/money-management/pull/259) **merged** (`c1adeb4`, 19:15Z) — Deploy Worker wiring for `WORKOS_WEBHOOK_SECRET`.
- Deploy run [34713619532](https://github.com/Stringsaeed/money-management/actions/runs/34713619532) **failure**, **0 steps**, billable `total_ms=0`. Annotation: *job was not started because recent account payments have failed or your spending limit needs to be increased*. **Hard-stop:** not a workflow/code fix PR.
- Because the job never started, `WORKOS_WEBHOOK_SECRET` **never reached prod**.
- [#232](https://github.com/Stringsaeed/money-management/issues/232) falsely closed by #259 merge keywords; **reopened** (`state_reason=reopened`).
- Live `GET https://auth.trove.ing/` → **200** `OK`.
- Live `POST https://auth.trove.ing/webhooks/workos` (empty JSON, no signature) → **503** `Webhook receiver is disabled: WORKOS_WEBHOOK_SECRET is not configured.`
- Runner `WORKOS_WEBHOOK_SECRET` **ABSENT** — not invented. Verdict: **BLOCKED** until owner clears Actions billing, sets secret, and redeploys successfully.
- Evidence: `workos-webhook-probe-2026-09-12T192327Z.txt` + `workos-webhook-after-259-still-503.md` + `workos-webhook-blocked.md`. Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## WorkOS webhook live re-probe (2026-09-12T14:19:32Z, no device)

- Prior live probe still **503** (`workos-webhook-probe-2026-09-12T141932Z.txt`). Superseded by post-#259 `2026-09-12T19:23:27Z` restamp above; verdict unchanged **BLOCKED**.

## WorkOS webhook prior re-probe (2026-09-12T07:54:12Z, no device)

- Prior live probe still **503** (`workos-webhook-probe-2026-09-12e.txt`). Superseded by later restamps; verdict unchanged **BLOCKED**.
...
## describeEffectTag / summarizeEffects Relates (2026-09-12, no device)

- Re-verify `packages/api/src/lib/activity/summary.test.ts` — **6/6 PASS** (`describe-summarize-effects-vitest-2026-09-12.txt`): every `EFFECT_TAGS` noun mapping; unknown tag passthrough; empty / single / two / Oxford-comma summarize paths.
- Row 4 / row 6 activity effect-summary seam → dedicated title; live device activity timeline still **BLOCKED** (#258); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## issuesFromZod / checkExpectedVersion / scopeColumns Relates (2026-09-12, no device)

- Re-verify `packages/api/src/lib/commands/handlers/shared.test.ts` — **4/4 PASS** (`issues-expected-version-scope-columns-vitest-2026-09-12.txt`): nested + root zod → ValidationIssue; expectedVersion absent/match → null; stale → `stale_version`; `scopeColumns` dual-write ledgerId/householdId.
- Row 4 / row 6 command handler shared pure seam → dedicated title; live command apply/device still **BLOCKED** (#258); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## isKillSwitchEngaged Relates (2026-09-12, no device)

- Re-verify `packages/api/src/lib/observability/kill-switch.test.ts` (`-t kill switch`) — **2/2 PASS** (`is-kill-switch-engaged-vitest-2026-09-12.txt`): truthy `on`/`true`/`1`/`ON`; absent/empty/`off`/`false`/`0` stay disengaged (companion to stamped `KILL_SWITCH_FLAG` / `LOCAL_ONLY_RESULT`).
- Row 6 remote kill-switch parse seam → dedicated title; live PowerSync/kill-switch env still **BLOCKED**; webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## sha256Hex Relates (2026-09-12, no device)

- Re-verify `packages/api/src/lib/migration/import-content.test.ts` (`-t sha256Hex`) — **1/1 PASS** (`sha256-hex-vitest-2026-09-12.txt`): stable lowercase 64-hex digest; deterministic repeat; different input → different digest.
- Row 6 import content hash seam → dedicated title (separate from Import-content row codec composite); live import/device still **BLOCKED** (#258); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## encodeLedgerSelection / decodeLedgerSelection Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/ledger-selection-store.test.ts` (`-t encodeLedgerSelection / decodeLedgerSelection`) — **3/3 PASS** (`encode-decode-ledger-selection-jest-2026-09-12.txt`): personal + household round-trip; null/empty/`household:`/whitespace/unknown prefix → personal fallback (SecureStore seam skipped).
- Row 5 ledger selection wire codec seam → dedicated title (companion to stamped `normalizeLedgerSelection`); live dual-identity still **BLOCKED**; webhook still **BLOCKED** (**503**).
- GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## personalImportBinding Relates (2026-09-12, no device)

- Re-verify `apps/mobile/lib/migration/import-binding.test.ts` (`-t personalImportBinding`) — **1/1 PASS** (`personal-import-binding-jest-2026-09-12.txt`): personal binding → `personal:${userId}` ledger id (companion to stamped `householdImportBinding`).
- Row 6 personal sync import binding seam → dedicated title; live enable-sync/device still **BLOCKED** (#258); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## serializeReturnTo / returnTo Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/return-to.test.ts` (`-t parseReturnTo / serializeReturnTo`) — **4/4 PASS** (`serialize-return-to-jest-2026-09-12.txt`): serialize screen href + profile household path; `returnTo.profileHousehold` / `current` / `parse` helpers (companion to stamped `hrefForInternal` / `parseReturnTo`).
- Row 2 / row 5 AuthKit return-target seam → dedicated title; live OTP/device still **BLOCKED** (AX); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## canPresentAuthSheet / openAuthSheetSession Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/auth-sheet-session.test.ts` (`-t canPresentAuthSheet|openAuthSheetSession`) — **6/6 PASS** (`can-present-open-auth-sheet-jest-2026-09-12.txt`): anonymous + session_revoked allow; resolving + signed_in block; open with target only / with reset grant (companion to stamped `AUTH_SHEET_CLOSED`).
- Row 2 AuthKit sheet session seam → dedicated title; live OTP/device AuthKit still **BLOCKED** (AX); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## toMembershipSummary / roleLabel Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/memberships.test.ts` — **4/4 PASS** (`to-membership-summary-role-label-jest-2026-09-12.txt`): admin/member/viewer mapping + Date→ISO; unknown role → null; Admin/Member/Viewer labels (dedicated title separate from composite Memberships role summary Jest).
- Row 4 client role boundary seam → dedicated title; live invite/device role UX still **BLOCKED** (#258); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## nextClaim Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/access.test.ts` (`-t nextClaim`) — **4/4 PASS** (`next-claim-jest-2026-09-12.txt`): session probe → held claim; identity match no-op; authoritative no_session keeps held; identity switch rewrite (`now` injected).
- Row 5 / row 7 claim advance seam → dedicated title; live dual-identity still **BLOCKED**; webhook still **BLOCKED** (**503**).
- GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## pickActiveHousehold Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/access.test.ts` (`-t pickActiveHousehold`) — **2/2 PASS** (`pick-active-household-jest-2026-09-12.txt`): selected household when membership exists; Personal / unknown id → null.
- Row 5 active household pick seam → dedicated title; live device household switch still **BLOCKED** (#258); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## resolveReturnDestination Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/access.test.ts` (`-t resolveReturnDestination`) — **3/3 PASS** (`resolve-return-destination-jest-2026-09-12.txt`): invoking screen when household active; Profile & household when none / revoked / anonymous.
- Row 2 / row 5 post-auth return destination seam → dedicated title; live OTP/device still **BLOCKED** (AX); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## householdReadFromQuery Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/access.test.ts` (`-t householdReadFromQuery`) — **4/4 PASS** (`household-read-from-query-jest-2026-09-12.txt`): live session identity over held claim; per-user cache isolation; probe-disabled keeps cache; pending until first page.
- Row 5 / row 7 household query read seam → dedicated title; live dual-identity still **BLOCKED**; webhook still **BLOCKED** (**503**).
- GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## commandEnvelopeSchema Relates (2026-09-12, no device)

- Re-verify `packages/api/src/lib/commands/schema.test.ts` (`-t commandEnvelopeSchema`) — **5/5 PASS** (`command-envelope-schema-vitest-2026-09-12.txt`): removed kind accepted; empty kind reject; personal scope without householdId; neither scope nor household reject; blank organizationId reject (companion to stamped `preconditionSchema` / `commandScopeSchema`).
- Row 4 / row 6 command wire envelope seam → dedicated title; live command apply/device still **BLOCKED** (#258); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## rejectionReason Relates (2026-09-12, no device)

- Re-verify `packages/api/src/lib/observability/metrics.test.ts` (`-t derives short reasons`) — **1/1 PASS** (`rejection-reason-vitest-2026-09-12.txt`): invalid_intent / missing_entity / conflict / local_only short reasons without payload leak.
- Row 6 observability rejection reason seam → dedicated title; live metrics/device still **BLOCKED**; webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## accountLifecyclePeriod Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/accounts/account-ledger-date.test.ts` — **2/2 PASS** (`account-lifecycle-period-jest-2026-09-12.txt`): valid `yyyy-MM-dd` → `yyyy-MM`; malformed Ledger Dates throw.
- Row 4 / row 6 account lifecycle period seam → dedicated title; live create/device still **BLOCKED** (#258); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## mapSessionSnapshot Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/session-probe.test.ts` (`-t mapSessionSnapshot`) — **4/4 PASS** (`map-session-snapshot-jest-2026-09-12.txt`): live user; first-probe unresolved; authoritative empty → no_session; transport failure → unreachable (never no_session).
- Row 5 session probe snapshot seam → dedicated title (separate from composite Session-probe async); live dual-identity still **BLOCKED**; webhook still **BLOCKED** (**503**).
- GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## isUnreachableFailure Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/session-probe.test.ts` (`-t isUnreachableFailure`) — **2/2 PASS** (`is-unreachable-failure-jest-2026-09-12.txt`): 401 reachable; network failure unreachable (companion to stamped `authFailureFromClient`).
- Row 5 / row 6 client unreachable classification seam → dedicated title; live dual-identity still **BLOCKED**; webhook still **BLOCKED** (**503**).
- GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## householdsQueryKeyForUser / householdUserIdForQuery Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/access/access.test.ts` (`-t live session identity|cached household pages isolated`) — **2/2 PASS** (`households-query-key-user-jest-2026-09-12.txt`): `householdUserIdForQuery` prefers live session / held / null when disabled; `householdsQueryKeyForUser` isolates cache keys per userId.
- Row 5 / row 7 household query key isolation seam → dedicated title (companion to stamped `householdReadFromQuery`); live dual-identity still **BLOCKED**; webhook still **BLOCKED** (**503**).
- GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.


## parseSetupAssignment Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/budgeting/setup-assignment.test.ts` — **10/10 PASS** (`parse-setup-assignment-jest-2026-09-12.txt`): empty/0/`12`/`12.3`/`12.34` → minor units; rejects `-1`/`1.001`/`.50`/`money`/`1,00`.
- Row 3 / row 6 guided setup Assignment parse seam → dedicated title (not covered by Card-dependency + setup-draft codec composite); live device budget activation still **BLOCKED** (#258); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## evaluateCardBudgetState Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/budgeting/card-dependency-evaluator.test.ts` — **4/4 PASS** (`evaluate-card-budget-state-jest-2026-09-12.txt`): unsupported Transaction discriminant throw; unsafe minor-unit refuse; one-amount cross-currency Transfer excluded from replay; unsafe aggregate of safe card deficits refuse.
- Row 3 / row 6 card budget evaluator seam → dedicated title (companion to stamped Card-dependency validation composite; not `sumUnfundedCardSpending` DB-adjacent aggregate); live device budget activation still **BLOCKED** (#258); webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## initialPowerSyncAvailability / recordPowerSyncConnection / isPowerSyncUnavailable Relates (2026-09-12, no device)

- Re-verify `apps/mobile/modules/powersync/availability.test.ts` — **2/2 PASS** (`powersync-availability-jest-2026-09-12.txt`): degrades only after ten continuous disconnected minutes (`POWERSYNC_DISCONNECT_THRESHOLD_MS`); reconnect resets outage window immediately (pure `now`-parameterized; companion to stamped `POWERSYNC_DISCONNECT_THRESHOLD_MS` const).
- Row 4 / row 6 PowerSync availability state-machine seam → dedicated title; live PowerSync mint/device still **BLOCKED**; webhook still **BLOCKED** (**503**).
- Dual-identity still **BLOCKED**; GH Actions still **BLOCKED** (billing). Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.
...
- **Restated 2026-09-12T19:28Z** on tip `50e8dfc`: product Actions still absent/blocked; interim local authority restamped in `local-ci-authority-2026-09-12.txt` (see section above). Still **not** Actions green.
...
| Restart survives session                                  | `BLOCKED`                      | No signed-in session on device (2026-09-12 anonymous pass). Profile opens signed-out AuthKit sheet; OTP AX historically blocked; `CERT_USER_*` ABSENT — cannot mint session without OTP. Not PASS.                                                                                                                                                                                                                    |
| Refresh rotation                                          | `BLOCKED`                      | Same — no signed-in session / no refreshable bearer on device. Not PASS.                                                                                                                                                                                                                                                                                                                                              |
...
| Anonymous local-only use                                                 | `PASS` (iOS agent-device)                    | iPhone 17 Pro 2026-09-12: Home/Settings/Envelopes/Accounts without sign-in; Profile opens signed-out AuthKit sheet; Cancel keeps local session (`anonymous-local-ios-2026-09-12.md`, `anonymous-0{1-6}-*.png`). Create Account FAB never pressed. App tip at capture `50e8dfcc`; matrix base `ad7cf561`.                                                                       |
...
**Row status: `PARTIAL` — anonymous local-only PASS; personal upload PASS; Create Account round-trip `BLOCKED`; two-device not run.**
...
| Sub-criterion                                          | Status                                        | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------ | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Explicit Household create (no implicit org on sign-in) | `PARTIAL` (API seam) / live `BLOCKED`         | API: `households/service.test.ts` **25**. Live device create **BLOCKED** 2026-09-12: signed-out only (`anonymous-04-signed-out-auth-sheet.png`); OTP AX blocked; `CERT_USER_*` ABSENT (`cert-user-powersync-hardstop-2026-09-12.txt`). Not PASS.                                                                                                                                                                                                          |
| Multi-Household switch                                 | `PARTIAL` (encode/decode seam) / live `BLOCKED` | Per-user ledger selection encode/decode/clear **PASS** automated (`ledger-selection-store.test.ts`); live device switch **BLOCKED** (no signed-in session / no CERT_*).                                                                                                                                                                                                                                                                                    |
| Invitations via WorkOS                                 | `PARTIAL` (API seam) / live `BLOCKED`         | API invite seam only. Live invite acceptance **BLOCKED** (no signed-in admin session).                                                                                                                                                                                                                                                                                                                                                                     |
...
**Row status: `PARTIAL` automated / live Household UX `BLOCKED` (no session / CERT_* ABSENT) / webhook apply `BLOCKED` (prod secret missing).**
...
| Live API/stream isolation                 | `PARTIAL` (auth-gate) / dual-identity `BLOCKED`                        | Auth-gate **PASS**: missing → **401** `missing_token`; forged JWT + forged org/user body → **401** `invalid_token` (`live-auth-gate-probe-2026-09-12.txt`; CF **7**+**8**). Authenticated cross-tenant negatives **BLOCKED** — `CERT_USER_A_TOKEN` / `CERT_USER_B_TOKEN` ABSENT (`cert-user-powersync-hardstop-2026-09-12.txt`).                                                                                                                                                                                                                                                                                                                                                                                                                      |

**Row status: `PARTIAL`.** Isolation seams + auth-gate + viewer pipeline + automated demotion-queue PASS; live dual-identity **BLOCKED** (CERT_* ABSENT); client stale-response after identity switch not device-certified.
...
| Sync-or-discard sign-out                                                                      | `PASS` (automated) / live `BLOCKED`                                         | Automated `use-sign-out.test.tsx` **4/4**. Live device sheet **BLOCKED** 2026-09-12: no signed-in session (anonymous AuthKit Cancel path); cannot exercise sync-or-discard without auth. Not PASS.                                                                                                                                                                                                                                                                                                                                                                    |
| Identity switching (cache / queue isolation)                                                  | `PASS` (automated) / live `BLOCKED`                                         | Automated cleanup/helpers PASS. Live dual-identity switch **BLOCKED** — `CERT_USER_A_TOKEN` / `CERT_USER_B_TOKEN` ABSENT (`cert-user-powersync-hardstop-2026-09-12.txt`).                                                                                                                                                                                                                                                                                                                                                                                              |
| Sign-out / deletion on iOS and Android                                                        | `BLOCKED` (iOS live) / Android not started                                  | iOS live sign-out path unreachable without session (2026-09-12). Android still not started (`android-runtime-blocked.md`).                                                                                                                                                                                                                                                                                                                                                                                                                                            |

**Row status: `PARTIAL`.** Deletion/admin/household API seams + automated sync-or-discard / session-cleanup PASS; live device sign-out and identity switch **BLOCKED** (no session / CERT_* absent).
