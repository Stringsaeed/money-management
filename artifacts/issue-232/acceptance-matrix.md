...
| HEAD | tip `PENDING_DOCS` updateAccount/archiveAccount payload schema stamp — product `9344bd3` (`updateAccountPayloadSchema`/`archiveAccountPayloadSchema` **4/4**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
