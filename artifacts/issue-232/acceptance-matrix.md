...
| HEAD | tip `8de399f` changeEffects stamp — product `f57ae8c` (`changeEffects` **2/2** new; suite **2/2**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
