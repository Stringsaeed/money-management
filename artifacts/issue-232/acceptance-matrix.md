...
| HEAD                | tip after this Relates stamp — **local CI authority** (tsc+vitest/jest PASS on `50e8dfc`, rebased onto `ad7cf561` webhook Relates; Actions billing still **BLOCKED** — do **not** claim Actions green); remaining **BLOCKED/FAIL**: webhook **503**, #258/#260/#263 Create Account **FAIL**, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
...
| Worktree            | `/tmp/wt-241/money-management` (local CI authority stamp); prior `/tmp/wt232` + Mac evidence from `/Users/saeed/Work/money-management-wt-232`                                                                                                                                                                                   |
| Live API            | `https://auth.trove.ing` — root **200 OK** (2026-09-12T19:23:27Z); Sync `getManifest` CF Worker **200** post-DDL; webhook still **503** after #259 (Deploy [34713619532](https://github.com/Stringsaeed/money-management/actions/runs/34713619532) Actions billing hard-stop; secret never reached prod) |
