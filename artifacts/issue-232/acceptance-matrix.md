...
| HEAD | tip `b2a4bb7` updateAccount/archiveAccount payload schema stamp — product `9344bd3` (`updateAccountPayloadSchema`/`archiveAccountPayloadSchema` **4/4**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
