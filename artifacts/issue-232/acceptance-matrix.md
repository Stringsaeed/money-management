...
| HEAD | tip `PENDING_DOCS` settlementEffects stamp — product `808deb0` (`settlementEffects` **2/2**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
