...
| HEAD | tip `e3e6f43` requireChangedCategoryIds stamp — product `1a4d27d` (`requireChangedCategoryIds` **2/2** new; suite **6/6**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
