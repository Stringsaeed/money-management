...
| HEAD | tip `fc668a5` recurringChangePayloadSchema stamp — product `e977612` (`recurringChangePayloadSchema` **4/4**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
