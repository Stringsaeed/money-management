...
| HEAD | tip `1c03c42aac4fd1c0038d6632e2050c43623183b0` isMandatoryUpdateManifest stamp — product `ca139d31af2ccc87f164968de7f7aebcea4d56e1` (`isMandatoryUpdateManifest` **1/1** new; suite **1/1**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
