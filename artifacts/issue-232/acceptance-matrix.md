...
| HEAD | tip `PENDING_DOCS` createAccount/createTransaction payload schema stamp — product `2558783` (`createAccountPayloadSchema`/`createTransactionPayloadSchema` **4/4**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
