...
| HEAD | tip `1bd96aa` card-dependency/setup-draft Jest stamp — product `d58a819` (`validateAccountDependencyFacts`/`decodeSetupDraft` **10/10**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
