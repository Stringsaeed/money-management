...
| HEAD                | tip after this Relates stamp — Mac device **FAIL** on PR #260 Create Account (`ed1fc13b`, `hittable=false`); remaining **BLOCKED/FAIL**: webhook **503**, #258/#260 Create Account **FAIL**, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
...
| Worktree            | `/tmp/wt232` (cloud parseSetupAssignment + evaluateCardBudgetState + PowerSync availability titles); prior Mac evidence from `/Users/saeed/Work/money-management-wt-232`                                                                                                                                                     |
