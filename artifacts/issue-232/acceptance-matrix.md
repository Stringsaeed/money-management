...
| HEAD | tip `PENDING_DOCS` isHouseholdRole/isCommandKind stamp — product `5bf4dc4` (`isHouseholdRole`/`isCommandKind` **4/4**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
