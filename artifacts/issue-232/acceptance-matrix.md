...
| HEAD                | tip `5bb597dcea51ee0ce7051286745647ade118e677` access/sql/widget-token stamp (product batch `063398781926f82f76b76c234f5f41e4760bf023`) — product `b45082be6f39da2fc5896e71166645105bd89bcb` (`queryRows` **3/3**; `ledgerReadInput` **5/5**; `authFailureFromClient` **2/2**; `hrefForInternal` / `parseReturnTo` **5/5**; `decideWidgetToken` **1/1**; `readBearerToken` / `jwksUrlForClient` **1/1**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
