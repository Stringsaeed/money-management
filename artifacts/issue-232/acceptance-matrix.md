...
| HEAD | tip `4ccc8dd67914bbd9cda046623a39850b0af9aa4f` formatCompactChartAmount stamp — product `06bacc09549ead46cbcc63324a2159697255fe25` (pre-existing `chart-utils.test.ts` **2/2** PASS; suite **2/2**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
