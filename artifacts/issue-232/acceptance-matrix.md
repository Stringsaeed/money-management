...
| HEAD | tip `00fac0b` draftFromRule stamp — product `748b771` (`draftFromRule` **2/2** new; suite **12/12**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
