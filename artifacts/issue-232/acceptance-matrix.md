...
| HEAD | tip `PENDING_DOCS` formatCompactChartAmount stamp — product `06bacc09549ead46cbcc63324a2159697255fe25` (pre-existing `chart-utils.test.ts` **2/2** PASS; suite **2/2**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
