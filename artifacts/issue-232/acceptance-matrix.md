...
| HEAD | tip `ebd1fa5` claim-store SecureStore Jest **8/8** (row 5/7 identity persistence seam; webhook still **503**; Create Account still **BLOCKED** on #258; dual-identity **BLOCKED**) |
