...
| HEAD | tip `PENDING_DOCS` ENABLE_SYNC_IDLE_DESCRIPTION stamp — product `9f9b471a5acc2dc46ee7f97cbbf92dac0fb6e81f` (`ENABLE_SYNC_IDLE_DESCRIPTION` **1/1** new; suite **1/1**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
