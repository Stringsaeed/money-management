...
| HEAD | tip `920e2c3` reconcile-freshness Jest stamp — product `10d0bd9` (`isStale`/`requireUserId` **7/7**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
