...
| HEAD | tip `5ea887b` requireCategoryIds stamp — product `7aa1468` (`requireCategoryIds` **2/2** new; suite **2/2**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
