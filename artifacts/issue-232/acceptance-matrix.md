...
| HEAD | tip `PENDING_DOCS` pendingDatesFrom/lifecycleAfterSettlement stamp — product `056faf4` (`pendingDatesFrom`/`lifecycleAfterSettlement` **4/4**); remaining **BLOCKED**: webhook **503**, #258 Create Account, dual-token, GH Actions billing, Android, OTP AX, PowerSync mint |
