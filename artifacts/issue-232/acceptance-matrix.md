...
| Live API            | `https://auth.trove.ing` — root **200 OK** (2026-09-12T14:19:32Z); Sync `getManifest` CF Worker **200** post-DDL; webhook still **503**                                                                                                                                                                          |
...
- Runner `WORKOS_WEBHOOK_SECRET` **ABSENT** — did not invent secrets. Verdict unchanged: **BLOCKED** (not PASS).
- Evidence: `workos-webhook-probe-2026-09-12T141932Z.txt` + `workos-webhook-blocked.md`. Relates to #232 only. Do not Closes #232/#224. Matrix still incomplete.

## WorkOS webhook prior re-probe (2026-09-12T07:54:12Z, no device)

- Prior live probe still **503** (`workos-webhook-probe-2026-09-12e.txt`). Superseded by `2026-09-12T14:19:32Z` restamp above; verdict unchanged **BLOCKED**.
