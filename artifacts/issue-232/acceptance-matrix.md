...
| Live API            | `https://auth.trove.ing` — root **200 OK** (2026-09-12T19:23:27Z); Sync `getManifest` CF Worker **200** post-DDL; webhook still **503** after #259 merge (Deploy Worker failed; owner redeploy required)                                                                                                           |
